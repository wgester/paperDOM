...
[![Build Status](https://travis-ci.org/wgester/accordion.svg?branch=master)](https://travis-ci.org/wgester/accordion) [![Dependency Status](https://david-dm.org/wgester/accordion.svg)](https://david-dm.org/wgester/accordion) [![devDependency Status](https://david-dm.org/wgester/accordion/dev-status.svg)](https://david-dm.org/wgester/accordion#info=devDependencies)
